...
export const en = {
  ...
  commandLineNoDirectory: 'No writable directory on PATH was found. Install Homebrew, or make /usr/local/bin writable, and try again.',
...
export const zh = {
  ...
  commandLineNoDirectory: '在 PATH 上找不到可写目录。请安装 Homebrew，或让 /usr/local/bin 可写后重试。',
