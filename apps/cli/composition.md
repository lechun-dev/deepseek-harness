...
flowchart LR
  ...
  plugin_dsh_base_multica_subprocess_env["multica-subprocess-env<br/>./plugins/multica-subprocess-env.js"]
  cfg --> plugin_dsh_base_multica_subprocess_env
...
| `multica-subprocess-env` | `./plugins/multica-subprocess-env.js` |
